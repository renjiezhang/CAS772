    ...
    with tf.Session() as sess:
        ...
        for i in range(STEPS):
            ...
            if i%5 == 0 or i+1 == STEPS:
                ...
                print('Step %d: Accuracy on random sampled %d examples = %.1f%%'% (i, BATCH, validation_accuracy*100))
        # final accuracy
        ...
        #save_path = saver.save(sess, "C:\\flowertransfer\\tmp")
        #save_path = saver.save(sess, "savedmodel/model.ckpt")
        #save_path = saver.save(sess, "C:\\flowertransfer\\tmp\\fashionmodel.ckpt")
        #print('Model saved')
